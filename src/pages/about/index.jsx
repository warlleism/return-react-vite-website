...
export default function About() {
    return (
        <>
            <HeaderCompoent />
            <div className="w-full flex flex-col items-center flex-wrap justify-center border-box pt-40">
                    ...
                    <SectionWrapper style={'fade-in-left'}>
                        <div className="flex flex-col gap-5 w-full">
                            <div className="flex justify-between w-full">
                                ...
                                <p className="text-about-container text-[1.5rem] w-[68%] tracking-tight">
                        ...
                        <div className="flex flex-col gap-5 w-full">
                            <div className="flex justify-between w-full">
                                ...
                                <div className="flex flex-col w-[68%]">
                                    <p className="text-about-container text-[1.5rem] w-[100%] tracking-tight">
                                    ...
                                    <p className="text-[1.5rem] w-[100%] tracking-tight">
