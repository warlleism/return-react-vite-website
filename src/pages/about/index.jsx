...
export default function About() {
    return (
        <>
            <HeaderCompoent />
            <div className="w-full flex flex-col items-center flex-wrap justify-center border-box p-40">
                <div className="text-[3rem] font-light text-[#1a1a1a] text-center mb-[120px]">SOBRE NÓS</div>
                <div className="text-[1.2rem] font-light text-[#1a1a1a] text-start w-[60%] mb-20 flex flex-col gap-[140px]">
                    <SectionWrapper style={'fade-in-left'}>
                        <div className="flex flex-col gap-5 w-full">
                            <div className="flex justify-between w-full">
                                <div className="img-about w-[30%] h-[300px]">
                                    <img src={Img1} alt="Full image" className="object-cover rounded-[5px] img-about w-[100%] h-[100%]" />
                                </div>
                                <p className="text-about-container text-[1.3rem] w-[68%] tracking-tight">
                            ...
                            <p className="text-[1.3rem] tracking-tight">
                    ...
                    <SectionWrapper style={'fade-in-rigth'}>
                        <div className="flex flex-col gap-5 w-full">
                            <div className="flex justify-between w-full">
                                <div className="flex flex-col w-[68%]">
                                    <p className="text-about-container text-[1.3rem] w-[100%] tracking-tight">
                                    ...
                                    <p className="text-[1.3rem] w-[100%] tracking-tight">
