        ...
        <SectionWrapper style={'fade-in-left'}>
            <div id="about" className="h-screen w-full flex justify-center items-center flex gap-10 relative overflow-hidden">
                ...
                <div className="w-[40vw] h-[70%] flex flex-col justify-center">
                    ...
                    <p className="font-ligth text-[1.1rem] tracking-[-1px] inline-block text-[#1a1a1a]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sed distinctio veritatis aspernatur iusto nam. Ipsam dignissimos quisquam consequuntur id! Beatae incidunt eveniet alias distinctio repudiandae, ut nostrum ipsum laborum?</p>
                    <a href='/galery' className="font-semibold w-[200px] h-[50px] rounded-md mt-5 z-30 cursor-pointer bg-[#1a1a1a] text-[1.2rem] text-[#fff] uppercase flex justify-center items-center items-center">GALERIA</a>
                </div>
