        ...
        <SectionWrapper style={'fade-in-left'}>
            <div id="about" className="h-screen w-full flex justify-center items-center flex gap-10 relative overflow-hidden">
                ...
                <div className="w-[40vw] h-[70%] flex flex-col justify-center">
                    <div className="mb-[-10px] font-semibold text-[3.5rem] tracking-[-2px] inline-block text-[#1a1a1a] uppercase">{t("home-page.about.title")}</div>
                    <div className="mb-[10px] font-semibold text-[1.5rem] mb-10 tracking-[-2px] inline-block text-[#1a1a1a] uppercase">{t("home-page.about.title")}</div>
                    <p className="font-ligth text-[1.1rem] tracking-[-1px] inline-block text-[#1a1a1a]">{t("home-page.about.description")}</p>
