        ...
        <>
            {
                images && (
                    <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center  z-30 cursor-">
                        ...
                        <img src={images} alt="Full image" className={`w-[50%] h-[80%] object-cover z-40 ${zoom == 2 ? 'scale-125' : ''}  transition-all duration-1000 ease-in-out md-max:w-[90%] h-[40%]`} />
                        <div className="absolute w-full z-30 h-full left-0 top-0 bg-[#0000004f]" onClick={() => handleModal('')} />
                    </div>
                )
            }
            <HeaderCompoent />
