...
export default function Header() {
    return (
        <div className='header-container h-[10vh] flex box-border px-10 items-center justify-between'>
            ...
            <a href='/contacts' className='button-contact flex gap-1.5 cursor-pointer font-medium px-5 py-2.5 items-center bg-[#fbfbfb] text-[#0a0a0a] transition ease-in-out duration-500 no-underline rounded-bl-md border-l border-b border-[#0a0a0a]'>
