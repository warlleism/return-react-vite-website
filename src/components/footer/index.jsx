...
export default function Footer() {
    return (
        <div className='h-[30vh] w-full flex box-border px-10 items-center justify-between m-auto bg-[#1a1a1a]'>
            ...
            <div className="h-[80%] w-[30%] flex justify-center">
                <div className="flex flex-col items-start justify-center gap-5 h-full ">
                    ...
                    <div className="flex gap-3">
                        <div className="border-box px-2 py-2 bg-[#fff] inline-block rounded-[100px] cursor-pointer">
